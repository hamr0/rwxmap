// Corpus loader, ported unchanged from the frozen POC (poc/step1/corpus.mjs)
// — reads the 15-provider corpus (data/provider-corpus-2026-09-16) and joins
// the 21 blind labelling files onto it. Test/dev tooling only — never part
// of the published library. Imports nothing from poc/flow or poc/archive.
//
