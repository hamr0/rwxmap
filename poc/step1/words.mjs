// Word/token helpers for poc/step1 — a partial copy of poc/flow/words.mjs
// (itself copied from poc/archive/m1). Only the pieces step 1 needs are
// here: the lead-token tokenizer and the verb-stem matcher, verbatim, plus
// one new function (leadVerbAfterModifiers) at the bottom. Imports nothing
// from poc/flow or poc/archive.
...
// --- lead verb after modifiers (new here, not in poc/flow) -----------------
